...
public class OwnerBilPay extends AppCompatActivity {
	TextView textVie,textVie1,textVie2,textVie3;
	EditText edPhone,editText;
	Button button;
	OwnerBilPay OwnerBilPay;
	public static OwnerBilPay BilPay = null;
	@Override
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_owner_bil_pay);
...
//
		...
		try {
			...
			Intent intent=new Intent(getApplicationContext(),OwnerbilPaid.class);
